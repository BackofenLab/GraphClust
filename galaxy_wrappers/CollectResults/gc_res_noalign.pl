...
foreach my $res_idx (@res_todo) {
  ...
  my $fa_top = NotalignTopResults( \%clus_hits, \@fa_scan, $results_top_num, $clus_dir, "top$results_top_num" );
...
sub NotalignTopResults {
  ...
  my $fa_file_sorted = "$resDir" . ".cluster.sorted.fa";g ljg 
